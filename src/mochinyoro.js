//
// パズル固有スクリプト部 モチにょろ版 mochinyoro.js v3.2.0
//
...
Puzzles.mochinyoro.prototype = {
	...
	answer_init : function(){
		ans.checkAns = function(){
			...
			if( !this.isAreaRect(warea, function(id){ return (bd.QaC(id)!=1);}) ){
			...
			if( !this.checkAllArea(barea, function(id){ return (bd.QaC(id)==1);}, function(w,h,a){ return (w*h!=a);} ) ){
