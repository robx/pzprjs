...
(function(pidlist, classbase) {
	...
	MouseEvent: {
		...
		inputcell_dosufuwa: function() {
			...
			if (cell.isnull || cell === this.mouseCell || cell.ques === 1) {
				return;
			}
			...
			if (this.inputData === null) {
				...
				(this.inputData === 1 && this.mouseCell.getdir(cell, 2) !== cell.UP) ||
				(this.inputData === 2 && this.mouseCell.getdir(cell, 2) !== cell.DN)
			) {
				return;
			}
