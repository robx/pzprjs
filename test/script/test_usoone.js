...
ui.debug.addDebugData('usoone', {
	...
	inputs : [
		...
		{ input:["mouse,left, 5,1"],
		  result:"pzprv3/usoone/1/5/1/0 0 0 0 0 /. . 1 . . /1 + +x + 1 /"},
		{ input:["newboard,6,1", "editmode", "cursor,1,1", "key,1,right,2,right,3,right,4,right,0,right,-,right,1", "playmode", "setconfig,use,1"] },
		...
		{ input:["ansclear", "mouse,right, 1,1", "mouse,rightx2, 3,1", "mouse,rightx3, 5,1", "mouse,rightx4, 7,1", "mouse,rightx5, 9,1", "mouse,rightx6, 11,1"],
		  result:"pzprv3/usoone/1/6/1/0 0 0 0 0 0 /1 2 3 4 0 1 /+ . + . + . /"},
		{ input:["ansclear", "setconfig,use,2", "mouse,left, 1,1", "mouse,leftx2, 3,1", "mouse,leftx3, 5,1", "mouse,leftx4, 7,1", "mouse,leftx5, 9,1", "mouse,leftx6, 11,1"],
		  result:"pzprv3/usoone/1/6/1/0 0 0 0 0 0 /1 2 3 4 0 1 /x o + +x +o . /"},
		{ input:["ansclear", "mouse,right, 1,1", "mouse,rightx2, 3,1", "mouse,rightx3, 5,1", "mouse,rightx4, 7,1", "mouse,rightx5, 9,1", "mouse,rightx6, 11,1"],
		  result:"pzprv3/usoone/1/6/1/0 0 0 0 0 0 /1 2 3 4 0 1 /+ . + . + . /"},
		{ input:["newboard,4,1", "editmode", "cursor,1,1", "key,1", "playmode", "setconfig,use,1"] },
