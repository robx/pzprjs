...
ui.debug.addDebugData('kakuru', {
	...
	inputs : [
		...
		{ input:["cursor,0,0", "mouse,leftx2, 1,1",  "mouse,leftx3, 3,1",  "mouse,leftx46, 5,1",  "mouse,leftx47, 7,1",
				 "cursor,0,0", "mouse,rightx2, 1,3", "mouse,rightx3, 3,3", "mouse,rightx46, 5,3", "mouse,rightx47, 7,3"],
		  result:"pzprv3/kakuru/2/4/? 1 44 . /44 43 ? . /. . . 0 /. . . 0 /" },
		/* 回答入力テスト */
